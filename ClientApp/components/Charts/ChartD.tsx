...
export class ChartD extends React.Component<Props, {}> {
    ...
    componentDidMount() {
        ...
        $(chart.container).on('mousedown.hc touchstart.hc', function (eStart: any) {
            ...
            $(document).on({
                'mousemove.hc touchmove.hc': function (e: any) {
                    // Run beta
    ...
    public render() {
        return <div className="jumbotron">
            ...
            <div id={this.chartUid} style={{minWidth: '310px', maxWidth: '800px', height: '400px', margin: '0 auto'}}/>
        </div>;
    }
}
