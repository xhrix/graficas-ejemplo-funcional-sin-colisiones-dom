...
} from "../../../lib/components/react-sortable-savable-grid/SortableSavableGrid";
...
const SortableSavableGridIFrames = () => (
    <div>
        <h1>Grid with iFrames</h1>
...
export default SortableSavableGridIFrames;
